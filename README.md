...
* [01. BLKEXPORT User Guide](https://github.com/egandavidpatrick-del/AutoRegisterUpdater/blob/18e35af0ce2cc4bc7f6620499584ec7b03a04e68/guide/user-guide/AUTO%20DOCUMENT%20ISSUE%20REGISTER%20UPDATER%20USER%20GUIDE%20VERSION%201.0.pdf)
...
BLKEXPORT uses the netDxf library to load and interpret ASCII and Binary DXF
files, building additional application logic to identify, classify, validate,
and export block information.

netDxf provides the underlying DXF object model, while BLKEXPORT implements the
domain-specific processing required to transform drawing data into structured
...
### Repository Scope
> As BLKEXPORT was developed as a bespoke production development, its source code remains private. This repository therefore provides the supporting materials for the solution, including architecture overview, user guide, application screenshots, and video demonstration.
...
# 🧭 BLKEXPORT (Case Study – Custom Utility Application)
<i>BLKEXPORT allows the user to generate a BOM (Bill of Material) from an AutoCAD DXF drawing the quick and easy way implemented in just 2 clicks. Export 10,009 blocks to CSV in just 2 seconds. This performance depends on the specification of your computer. Refer to the Specification of the Reference Test Machine in the BLKEXPORT User Guide in this repository page 4.</i>
<p align="left">
